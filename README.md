...
- **Website**: [Health Plus](https://health-plus-lilac.vercel.app/ "Health Plus")
- **Framework**: React.js
...
- Deployed using Vercel App for easy access and sharing.
...
The website is deployed using Vercel App and can be accessed at [https://health-plus-lilac.vercel.app/](https://health-plus-lilac.vercel.app/).

## Getting Started

To run the project locally:

1. Clone this repository: `https://github.com/Satendra-Rai/Health-Plus.git`
