...
- **Website**: [Health Plus](https://health-plus-psi.vercel.app/ "Health Plus")
- **Framework**: React.js
...
The website is deployed using Vercel App and can be accessed at [https://health-plus-psi.vercel.app/](https://health-plus-psi.vercel.app/).

## Getting Started

To run the project locally:

1. Clone this repository: `https://github.com/Satendra-Rai/Health-Plus`
